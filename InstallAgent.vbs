...
strMode = ""
strSpin = "|"
strVersion = "4.00"				' The current version of this script
...
CONST strServerAddress = "vision.gcicom.net"		' The FQDN or IP address of your N-central server
CONST strBranding = "GCI Vision"					' Branding label, eg. 'ACME MSP monitoring'.  Used in popup messages as the window title
CONST strAgentFolder = "Vision"						' This is the name of the folder within NETLOGON where you have placed the agent installer
...
CONST strContactAdmin = "Please contact GCI Managed IT support on 0844 443 4488 or managedit.support@gcicom.net for assistance."		' Your contact info
